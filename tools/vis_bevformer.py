...
if __name__ == '__main__':
    ...
    bevformer_results = mmcv.load('/data/workspace/lhjj/PETR-main/test/petr_r50dcn_gridmask_c5/Wed_Jan__3_15_24_23_2024/pts_bbox/results_nusc.json')
    sample_token_list = list(bevformer_results['results'].keys()) # 4fbd8ca56cc942cfb092846192fb3bd3
    sample_token = '4fbd8ca56cc942cfb092846192fb3bd3'
